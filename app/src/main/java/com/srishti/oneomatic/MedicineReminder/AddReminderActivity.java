package com.srishti.oneomatic.MedicineReminder;
...
import com.srishti.oneomatic.MedicineReminder.data.AlarmReminderContract;
import com.srishti.oneomatic.MedicineReminder.reminder.AlarmReceiver;
import com.srishti.oneomatic.MedicineReminder.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    private com.getbase.floatingactionbutton.FloatingActionButton mFAB1;
    private com.getbase.floatingactionbutton.FloatingActionButton mFAB2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFAB1 = (com.getbase.floatingactionbutton.FloatingActionButton) findViewById(R.id.starred1);
        mFAB2 = (com.getbase.floatingactionbutton.FloatingActionButton) findViewById(R.id.starred2);

        if (mCurrentReminderUri == null) {

            setTitle("Add Medicine Reminder Details");
    ...
    public void setTime(View v){
        if(mCurrentReminderUri == null){
            Toast.makeText(this, "click again on the Medicine list to set time alarm", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void setDate(View v){
        if(mCurrentReminderUri == null){
            Toast.makeText(this, "click again on the Medicine list to set date alarm", Toast.LENGTH_LONG).show();
            return;
        }
        Calendar now = Calendar.getInstance();
